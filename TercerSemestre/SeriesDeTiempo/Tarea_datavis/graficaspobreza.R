...
pobpobre_graph <- ggplot(pobpobre, aes(x= anio, y= porcentaje)) +
  geom_line() + 
  scale_fill_brewer(palette = "Set1") +
  theme(legend.position="none") +
  labs(y= "Porcentaje", x = "Año") +
  ylim(10, 40) +
  ggtitle("Porcentaje de la población en situación de pobreza en Sonora: 2016-2022")
...
pobpobre_graph_Mex <- ggplot(pobpobre_Mex, aes(x= anio, y= porcentaje)) +
  geom_line() + 
  scale_fill_brewer(palette = "Set1") +
  theme(legend.position="none") +
  labs(y= "Porcentaje", x = "Año") +
  ylim(10, 60) +
  ggtitle("Porcentaje de la población en situación de pobreza en México: 2016-2022")
...
pobpobreExt_graph <- ggplot(pobpobreExt, aes(x= anio, y= porcentaje)) +
  geom_line() + 
  scale_fill_brewer(palette = "Set1") +
  theme(legend.position="none") +
  labs(y= "Porcentaje", x = "Año") +
  ylim(0, 5) +
  ggtitle("Porcentaje de la población en situación de pobreza extrema en Sonora")
...
#### Codigo de treemap ---
  ...
  treemap_pobreza <- treemap_pobreza_data %>% 
    ...
    hc_title(text = "Población en situación de pobreza por entidad federativa: 2016-2022")
...
pobpobre_norte_graph <- ggplot(pobpobre_norte, 
  ...
  ylim(0, 40) +
  labs(title="Porcentaje de la población en situación de pobreza en la frontera norte: 2016-2022")
...
# cambiamos nombre de columnas para evitar reduncancia
carencias_Mex_1622_wider <- rename(carencias_Mex_1622_wider,`servicios de salud` = `Carencia por acceso a los servicios de salud`)
carencias_Mex_1622_wider <- rename(carencias_Mex_1622_wider,`seguridad social` = `Carencia por acceso a la seguridad social`)
carencias_Mex_1622_wider <- rename(carencias_Mex_1622_wider,`calidad y espacios de la vivienda` = `Carencia por calidad y espacios de la vivienda`)
carencias_Mex_1622_wider <- rename(carencias_Mex_1622_wider,`acceso a los servicios básicos en la vivienda` = `Carencia por acceso a los servicios básicos en la vivienda`)
carencias_Mex_1622_wider <- rename(carencias_Mex_1622_wider,`acceso a la alimentación nutritiva` = `Carencia por acceso a la alimentación nutritiva y de calidad`)
